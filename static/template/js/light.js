...
/*=============================================================================*/
  this.renderL = function(){
    ...
    while(i--){
      ...
      this.ctx.strokeStyle = 'hsla(50, 100%, 53%, '+this.rand(10, 100)/100+')';
      ...
      if(!light.hasFired){
        this.ctx.fillStyle = 'rgba(255, 213, 13, '+this.rand(4, 12)/100+')';
        this.ctx.fillRect(0, 0, this.cw, this.ch);
      }

      if(this.rand(0, 30) == 0){
        this.ctx.fillStyle = 'rgba(255, 213, 13, '+this.rand(1, 3)/100+')';
        this.ctx.fillRect(0, 0, this.cw, this.ch);
      }
